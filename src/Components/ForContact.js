  ...
  return (
    ...
    <div className="container contact-div pl-5 pr-5 pb-5">
      ...
      <div className="col-lg-12 pl-5 pr-5 pb-5 ">
        ...
        <h5 className='text-start contact-text2' data-aos-once="true" data-aos="fade-left">- send me an email or shoot me a message on <a className='linked-in' target="_blank" href='https://www.linkedin.com/in/ebenezhar-selvakumar-059559136/'>LinkedIn!</a></h5>
